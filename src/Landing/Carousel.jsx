...
const Carousel = () => {
  ...
  const getTranslateX = () => {
    const centerOffset = visibleImages ==3? (100 / visibleImages): (397 / visibleImages)/2;
  ...
  return (
    <div className="mt-32 px-4">
      ...
      <div className="relative flex items-center justify-center mt-10 overflow-hidden py-4 px-10">
        ...
        <img
          src={phone}
          className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-full ${visibleImages==5?("scale-110"):"scale-90"} md:w-1/5 z-20`}
        />
        <div
